...
const string strMessageMagic = "NonameCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight <= 1)
	nSubsidy = 60000 * COIN; // first 1 blocks are 60000 coin reward
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in NonameCoin
    bool fStrictPayToScriptHash = true; // Always active in NonameCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NonameCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "18/11/14 - Blockchain Launches";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1416312000;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1924719;
        ...
        assert(block.hashMerkleRoot == uint256("0xd1691b690cc310a599a9070d5e17c7ba5c116552d726ba0a3af3ba9f28e29cb6"));
